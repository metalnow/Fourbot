 ...
 */
  ...
  /**************************************************************************************/
   ...
   /* GPS protocol 
	...
	//#define MAG_DECLINIATION	-3.267f				// For Taiwan South
	#define MAG_DECLINIATION	-4.05f				//For Taiwan Taipei
  ...
  /********************************************************************/
    ...
    #define VBATLEVEL_WARN1 104 // (*) (**) 10,7V
    #define VBATLEVEL_WARN2 100 // (*) (**) 9.9V
    #define VBATLEVEL_CRIT   96 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
  ...
  /********************************************************************/
    ...
    #define PINT2mA 50     /* (*) hard: one integer step on arduino analog translates to mA (example 4.9 / 37 * 1000) ;
  ...
  /* Experimental altitude hold code. It uses "vario mode" which means rising/descending vario relates to the throttle stick position.
     When RTH_ALT_MODE is uncommented, in RTH mode copter rises to defined altitude, and when reaches the target, descends back to defined home altitude.
       By default, copter descends back to RTH altitude, if is higher. When RTH_KEEP_ALT is uncommented, 
  ...
  /********************************************************************/
     ...
     */
    #define BOARD_NAME "MultiWii Pro"
    //                  123456789.123456
